...
const projects = [
  ...
  },
  {
    ...
    summary: "KratosRx connects patients with physician-prescribed GLP-1 treatments shipped directly to their door, making medical weight management accessible and convenient. Built for individuals ready to take control of their health with clinical-grade support.",
    tags: ["Web App", "Healthcare"],
    metric: "Physician-prescribed GLP-1 plans, Direct-to-door delivery, Telehealth-driven onboarding, Patient-focused care model",
