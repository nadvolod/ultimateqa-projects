...
const projects = [
  ...
  },
  {
    ...
    summary: "KratosRx connects patients with physician-prescribed GLP-1 treatments shipped directly to their door, making modern metabolic healthcare accessible and effortless. Built for individuals ready to take control of their health journey from home.",
    tags: ["Healthcare", "SaaS", "Web App", "Platform"],
    metric: "Physician-prescribed GLP-1 therapy, At-home delivery model, Telehealth-powered care, Patient-first onboarding, Direct-to-door fulfillment",
