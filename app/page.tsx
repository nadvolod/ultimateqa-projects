...
const projects = [
  ...
  },
  {
    ...
    summary: "KratosRx connects patients with physician-prescribed GLP-1 treatments delivered directly to their door, making medically supervised weight management accessible and convenient.",
    tags: ["Healthcare", "Web App", "SaaS", "Lead Generation"],
    metric: "Physician-prescribed GLP-1 therapy, Direct-to-door delivery, Online medical consultation, Personalized care plans, Telehealth-enabled platform",
