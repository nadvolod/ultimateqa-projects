...
const projects = [
  ...
  },
  {
    ...
    summary: "A sleek Next.js personal portfolio site for Carmen Ramirez, showcasing her work and professional identity with a modern, performant web presence.",
    tags: ["Personal Brand", "Portfolio", "Web App"],
    metric: "Next.js powered site, Vercel edge deployment, Optimized font loading, Fast iterative editing",
